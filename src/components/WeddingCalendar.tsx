...
const HouseIllustration = () => (
   <svg
      viewBox="0 0 100 100"
      className="w-full h-full text-[#bf9c85]"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.2"
      ...
      <path
         d="M12,82 C8,70 8,50 18,35 C23,45 18,65 12,82 Z"
         fill="currentColor"
         fillOpacity="0.04"
         stroke="none"
      />
      <path
         d="M88,82 C92,70 92,50 82,35 C77,45 82,65 88,82 Z"
         fill="currentColor"
         fillOpacity="0.04"
         stroke="none"
      />
      ...
      />
      <path
         d="M68,20 C68,16 64,14 68,10 C72,14 68,16 68,20 Z"
         fill="#f43f5e"
         stroke="none"
         transform="scale(0.85) translate(11, 2)"
      />
      {/* Grand Arch Doorway */}
      <path
         d="M42,82 L42,63 C42,58 58,58 58,63 L58,82"
         strokeLinecap="round"
      />
      {/* Rose window */}
      <circle
...
const ChurchIllustration = () => (
   <svg
      ...
      />
      <path
         d="M20,85 L20,65 L30,65"
         strokeLinecap="round"
         strokeLinejoin="round"
      />
      <path
         d="M80,85 L80,65 L70,65"
         strokeLinecap="round"
         strokeLinejoin="round"
      />
      ...
      <path
         d="M43,85 L43,69 C43,64 57,64 57,69 L57,85"
         strokeLinecap="round"
      />
      <path
         d="M39,85 L39,66 C39,59 61,59 61,66 L61,85"
         strokeLinecap="round"
         className="text-[#bf9c85]/55"
      />
...
const BanquetIllustration = () => (
   <svg
      ...
      <path
         d="M8,18 C13,18 18,13 18,8 C18,13 23,18 28,18 C23,18 18,23 18,28 C18,23 13,18 8,18"
         fill="currentColor"
         fillOpacity="0.08"
         stroke="none"
      />
      <path
         d="M72,22 C75,22 77,19 77,16 C77,19 79,22 82,22 C79,22 77,24 77,27 C77,24 75,22 72,22"
         fill="currentColor"
         fillOpacity="0.08"
         stroke="none"
      />
      ...
      <path
         d="M24,71 Q37,77 50,71 Q63,77 76,71"
         strokeLinecap="round"
      />
      <path
         d="M32,53 Q50,59 68,53"
         strokeLinecap="round"
      />
      <path
      ...
      />
      <path
         d="M50,15 C51,17 50,19 50,20 C49,19 49,17 50,15 Z"
         fill="#eab308"
         stroke="none"
      />
...
const WelcomeIllustration = () => (
   <svg
      ...
      />
      <path
         d="M48,12 L50,8 L52,12 L56,14 L52,16 L50,20 L48,16 L44,14 Z"
         fill="currentColor"
         fillOpacity="0.08"
         stroke="none"
      />
      ...
      <g transform="translate(10, 0) rotate(-12, 40, 50)">
         {/* Bowl */}
         <path
            d="M32,25 L48,25 L45,52 C44,58 36,58 35,52 Z"
            fill="currentColor"
            fillOpacity="0.03"
         />
         {/* Stem */}
      ...
      <g transform="translate(-10, 0) rotate(12, 60, 50)">
         {/* Bowl */}
         <path
            d="M52,25 L68,25 L65,52 C64,58 56,58 55,52 Z"
            fill="currentColor"
            fillOpacity="0.03"
         />
         {/* Stem */}
...
export default function WeddingCalendar() {
   ...
   return (
      <section
         id="calendar-section"
         className="py-16 px-4 bg-gradient-to-b from-[#faf6f0] to-[#fcfaf7] border-y border-[#ece4db] select-none text-[#2c2523]">
         <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-12">
               <motion.p
                  ...
                  Սիրելի՜ հյուրեր, Սիրով հրավիրում ենք ձեզ մասնակցելու մեր
                  հարսանյաց արարողությանը և մեզ հետ կիսելու մեր կյանքի
                     ...
                     {[
                        ...
                        return (
                           <motion.div
                              ...
                              className={`group bg-white/75 backdrop-blur-xs border border-[#eddccb]/60 rounded-3xl p-5 hover:shadow-md hover:border-[#bf9c85]/50 hover:bg-white transition-all duration-500 flex flex-row items-center gap-5 sm:gap-6 ${
